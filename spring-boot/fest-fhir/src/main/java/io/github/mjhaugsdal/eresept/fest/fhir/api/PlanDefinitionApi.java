...
import io.github.mjhaugsdal.eresept.fest.fhir.model.PlanDefinition;
...
public class PlanDefinitionApi {
  private ApiClient apiClient;

  public PlanDefinitionApi() {
    this(Configuration.getDefaultApiClient());
  }

  public PlanDefinitionApi(ApiClient apiClient) {
   ...
   */
  public PlanDefinition getPlandefinition(String source, String nameLanguage, String identifier, String tag, String name, String security, LocalDate lastUpdated, String id, String format, Integer count, String ct) throws ApiException {
    return getPlandefinitionWithHttpInfo(source, nameLanguage, identifier, tag, name, security, lastUpdated, id, format, count, ct).getData();
  }
   ...
   * @param count Page size. Max 1000 ressources per page. (optional)
   * @param ct Token for a given page. Token for the next page is provided as part of the response object. (optional)
   * @return ApiResponse&lt;PlanDefinition&gt;
   * @throws ApiException if fails to make API call
   * @http.response.details
     <table border="1">
       <caption>Response Details</caption>
   ...
   */
  public ApiResponse<PlanDefinition> getPlandefinitionWithHttpInfo(String source, String nameLanguage, String identifier, String tag, String name, String security, LocalDate lastUpdated, String id, String format, Integer count, String ct) throws ApiException {
    // Query parameters
    ...
    GenericType<PlanDefinition> localVarReturnType = new GenericType<PlanDefinition>() {};
    return apiClient.invokeAPI("PlanDefinitionApi.getPlandefinition", "/PlanDefinition", "GET", localVarQueryParams, null,
                               new LinkedHashMap<>(), new LinkedHashMap<>(), new LinkedHashMap<>(), localVarAccept, localVarContentType,
                               localVarAuthNames, localVarReturnType, false);
  }
  /**
   * Get Plan Definition
   * Get a PlanDefinition by its ID
   * @param source Identifies where the resource comes from (optional)
   * @param nameLanguage Language code for this name (optional)
   * @param identifier Business identifier for this product. Could be an MPID (optional)
   * @param tag Tags applied to this resource (optional)
   ...
   */
  public PlanDefinition getPlandefinitionId(String source, String nameLanguage, String identifier, String tag, String name, String security, LocalDate lastUpdated, String id, String format, Integer count, String ct) throws ApiException {
    return getPlandefinitionIdWithHttpInfo(source, nameLanguage, identifier, tag, name, security, lastUpdated, id, format, count, ct).getData();
  }
   ...
   */
  public ApiResponse<PlanDefinition> getPlandefinitionIdWithHttpInfo(String source, String nameLanguage, String identifier, String tag, String name, String security, LocalDate lastUpdated, String id, String format, Integer count, String ct) throws ApiException {
    // Query parameters
    List<Pair> localVarQueryParams = new ArrayList<>(
            apiClient.parameterToPairs("", "_source", source)
    );
    ...
    String[] localVarAuthNames = new String[] {"apiKeyQuery", "apiKeyHeader"};
    GenericType<PlanDefinition> localVarReturnType = new GenericType<PlanDefinition>() {};
    return apiClient.invokeAPI("PlanDefinitionApi.getPlandefinitionId", "/PlanDefinition/{id}", "GET", localVarQueryParams, null,
                               new LinkedHashMap<>(), new LinkedHashMap<>(), new LinkedHashMap<>(), localVarAccept, localVarContentType,
                               localVarAuthNames, localVarReturnType, false);
  }
}
