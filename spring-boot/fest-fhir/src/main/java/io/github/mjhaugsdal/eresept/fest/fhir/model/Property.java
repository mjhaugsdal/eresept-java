...
public class Property extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(Property.class.getName());

    public static class PropertySerializer extends StdSerializer<Property> {
        ...
        @Override
        public void serialize(Property value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
            jgen.writeObject(value.getActualInstance());
        }
    }

    public static class PropertyDeserializer extends StdDeserializer<Property> {
        ...
        public Property deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            throw new IOException(String.format("Failed deserialization for Property: %d classes match result, expected 1", match));
        }
         ...
         */
        @Override
        public Property getNullValue(DeserializationContext ctxt) throws JsonMappingException {
            throw new JsonMappingException(ctxt.getParser(), "Property cannot be null");
        }
    }
    ...
    static {
        ...
        JSON.registerDescendants(Property.class, Collections.unmodifiableMap(schemas));
    }
