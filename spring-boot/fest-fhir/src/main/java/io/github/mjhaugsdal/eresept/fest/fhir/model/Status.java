...
public class Status extends AbstractOpenApiSchema {
    ...
    public static class StatusDeserializer extends StdDeserializer<Status> {
        ...
        public Status deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            throw new IOException(String.format("Failed deserialization for Status: %d classes match result, expected 1", match));
        }
         ...
         */
        @Override
        public Status getNullValue(DeserializationContext ctxt) throws JsonMappingException {
            throw new JsonMappingException(ctxt.getParser(), "Status cannot be null");
        }
    }
    ...
    static {
        ...
        JSON.registerDescendants(Status.class, Collections.unmodifiableMap(schemas));
    }
